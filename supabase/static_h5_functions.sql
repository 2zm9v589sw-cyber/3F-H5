...
grant execute on function public.public_get_coupon(text) to anon, authenticated;
grant execute on function public.public_issue_coupon(text, uuid, text, numeric) to anon, authenticated;
grant execute on function public.public_redeem_coupon(text, uuid, numeric, text, text) to anon, authenticated;
